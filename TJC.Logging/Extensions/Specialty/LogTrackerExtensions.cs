...
{
    public static LogTracker LogStart(this ILogger logger,
                                      ...
                                      [CallerLineNumber] int lineNumber = 0)
    {
        ...
        logger.LogMetadata(logLevel: LogLevel.Trace,
                           ...
                           message: Settings.Settings.Instance.Formatting.Specialty.Tracker.ToString(null, tracker),
                           frameIndex: 1,
    ...
    private static void LogEndInternal(this ILogger logger,
                                       LogTracker? tracker = null,
                                       CompletionStatus completionStatus = CompletionStatus.Success,
                                       Exception? exception = null,
                                       int frameIndex = 0,
