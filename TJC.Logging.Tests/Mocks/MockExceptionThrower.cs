...
internal static class MockExceptionThrower
{
    ...
    public static void CallMethodToThrowException(string message) =>
    ...
    public static void CallMethodToThrowExceptionWithInnerException(string message, string innerMessage) =>
